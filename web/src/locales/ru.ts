...
**Основные правила:**
  ...
  - **Всегда учитывайте** всю историю диалога.`,
      ...
      useKnowledgeGraphTip:
        'Использовать ли граф(ы) знаний в указанных базах знаний при извлечении для многошагового Q&A. Включает итеративные поиски по сущностям, связям и отчётам сообществ; увеличивает время извлечения.',
      ...
      tavilyApiKeyTip:
        'При корректном API ключе Tavily веб-поиск дополняет извлечение из базы знаний.',
